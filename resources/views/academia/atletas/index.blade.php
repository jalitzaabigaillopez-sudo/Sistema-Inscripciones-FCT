...
@section('content')
    ...
    <div class="container py-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <button id="btnNuevoAtleta" type="button" class="btn btn-success btn-md rounded-pill ms-auto"
                data-bs-toggle="modal" data-bs-target="#modalAtleta" aria-controls="modalCrear" aria-label="Nuevo atleta">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="id_academia" class="form-label">Academia <span
                                                        class="text-danger">*</span></label>
                                                <input type="hidden" name="id_academia"
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="d-flex justify-content-center gap-2">
                                <button class="btn btn-sm btn-warning rounded-pill btn-edit"  name="editar"
                                        data-id="${data}" title="Editar">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                                <button class="btn btn-sm btn-danger rounded-pill" name="eliminar"
