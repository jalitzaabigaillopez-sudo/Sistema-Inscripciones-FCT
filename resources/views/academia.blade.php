...
<nav class="sidebar" id="sidebar">
    ...
    <a href="#" onclick="handleSidebarClick(event)"><i class="bi bi-bar-chart-line"></i> Avance de eventos</a>
    <a href="#" onclick="handleSidebarClick(event)"><i class="bi bi-graph-up"></i> Estadística atletas/eventos</a>
    <a href="#" onclick="handleSidebarClick(event)"><i class="bi bi-bar-chart-line me-2"></i><span>Reportes</span></a>
</nav>
    <!-- Navbar -->
