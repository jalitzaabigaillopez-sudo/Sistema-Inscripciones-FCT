...
@section('content')
    <div class="container py-4">
                ...
                <div class="modal-content p-4 border-0 shadow-lg" style="background-color: #f8f9fa;">
                    ...
                    <div class="modal-body p-0">
                        <form method="POST" action="{{ route('grados.store') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="nombreGrado" class="form-label">Nombre <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm" id="nombreGrado" name="nombre"
                                    required>
                            </div>
                            <div class="mb-3">
        ...
        {{-- Modal EDITAR --}}
        <div class="modal fade" id="modalEditarGrado" tabindex="-1" aria-labelledby="modalEditarGradoLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content p-4 border-0 shadow-lg" style="background-color: #f8f9fa;">
                    <div class="modal-header border-bottom-0 pb-2">
                    ...
                    <div class="modal-body p-0">
                        <form method="POST" id="formEditarGrado">
                            ...
                            @method('PUT')
                            <div class="mb-3">
                                <label for="editNombreGrado" class="form-label">Nombre <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm" id="editNombreGrado"
...
@section('scripts')
    <script>
        $(document).ready(function() {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <form action="/grados/${id_grado}" method="POST"
                                id="form-eliminar-${id_grado}" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-sm btn-danger rounded-pill"
                                    data-bs-toggle="tooltip" title="Eliminar Grado"
                                    onclick="confirmarEliminacion(${id_grado}, 'grados')">
                                    <i class="bi bi-trash"></i>
                                </button>
                            </form>
                        </div>
            ...
            initDataTable({
                ajaxUrl: "{{ route('grados.index') }}",
                columns: columnsConfig,
                tableId: "tabla-grados"
            });
        });
    </script>
@endsection
