...
<div class="container mt-4">
    <h2 class="mb-4">Academias</h2>
    <!-- Botón para abrir el modal -->
    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#crearAcademiaModal">
        ➕ Crear Nueva Academia
    </button>

    <!-- Modal -->
    <div class="modal fade" id="crearAcademiaModal" tabindex="-1" aria-labelledby="crearAcademiaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('academias.store') }}">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="crearAcademiaModalLabel">Crear Nueva Academia</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre de la Academia</label>
                            <input type="text" class="form-control" id="nombre" name="nombre" required placeholder="Ej. Academia Central">
                        </div>
                        <div class="mb-3">
