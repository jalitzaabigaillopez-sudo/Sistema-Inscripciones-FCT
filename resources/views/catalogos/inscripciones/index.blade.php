...
<div class="container py-4">
    <h4 class="fw-bold mb-4">Listas de Inscripciones</h4>

    {{-- Buscador y botón --}}
    <div class="d-flex justify-content-between align-items-center mb-4">
        <form method="GET" action="{{ route('inscripciones.index') }}" class="w-50">
            <div class="input-group">
                <span class="input-group-text bg-light"><i class="bi bi-search"></i></span>
                <input type="text" name="busqueda" class="form-control" placeholder="Buscar inscripción...">
            </div>
        </form>

        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalInscripcion">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalInscripcionLabel">Crear Nueva Inscripción</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="fechaInscripcion" class="form-label">Fecha inscripcion</label>
                                <input type="text" class="form-control" id="fechaInscripcion" placeholder="Fecha inscripcion">
                            </div>
                           
                            <div class="col-md-6">
                                <label for="estadoInscripcion" class="form-label">Estado</label>
                                <select class="form-select" id="estadoInscripcion">
    ...
    <div class="d-flex justify-content-end mt-3">
        <nav aria-label="Navegación de inscripciones">
