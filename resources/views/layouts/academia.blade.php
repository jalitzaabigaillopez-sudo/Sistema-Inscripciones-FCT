  ...
  <div class="d-flex">
    ...
    <div class="sidebar p-3">
      <div class="text-center mb-3">
          <img src="/images/vectlogo.png" alt="" class="img-fluid" style="max-height: 80px;">
      </div>
      <h4 class="mb-4">Panel Academia</h4>
      <a href="#"><i class="bi bi-pencil-square"></i> Inscripción a Eventos</a>
      <a href="#"><i class="bi bi-person"></i> Atletas</a>
      <a href="#"><i class="bi bi-bar-chart"></i> Estadísticas</a>
      <a href="#"><i class="bi bi-flag"></i> Avance de Eventos</a>
    </div>
    ...
    <div class="flex-grow-1">
      ...
      <div class="header d-flex justify-content-between align-items-center p-3">
        <h2 class="text-primary">Dashboard Academia</h2>
        <div class="dropdown">
