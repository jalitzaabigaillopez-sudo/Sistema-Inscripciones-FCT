                ...
                <div class="card p-4">
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <input type="text" class="form-control" name="nombreAcademia" id="nombreAcademia"
                                placeholder="Ej. Academia Taekwondo XYZ" required>
                        </div>
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <input type="email" class="form-control" name="correo" id="correo"
                                placeholder="Ej. contacto@academia.com" required>
                        </div>
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <textarea class="form-control" name="comentario" id="comentario" rows="3"
                                placeholder="Motivo de la solicitud, trayectoria, etc."></textarea>
                        </div>
                        <!-- SweetAlert2 -->
                        ...
                        <button type="button" class="btn btn-primary px-4" id="btnPreregistro">Enviar
                            Solicitud</button>
